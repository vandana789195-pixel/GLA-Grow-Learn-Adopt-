...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (timelineButtons.length > 0 && milestoneCards.length > 0) {
        ...
        function showMilestone(ageGroup) {
            ...
            const selectedCard = document.querySelector(`.milestone-card[data-age="${ageGroup}"]`);
            if (selectedCard) {
            ...
            const activeButton = document.querySelector(`.timeline-btn[data-age="${ageGroup}"]`);
            if (activeButton) {
    ...
    console.log('%c🌱 GLA - Grow Learn Adopt', 'color: #FF6B9D; font-size: 24px; font-weight: bold;');
    console.log('%cWelcome to our educational website!', 'color: #4ECDC4; font-size: 16px;');
    console.log('%cSupporting families in nurturing early language and communication skills.', 'color: #546E7A; font-size: 14px;');
